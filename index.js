const sessionName = "Wagwans";
const antiforeign = process.env.ANTIFOREIGN || 'FALSE';
const autobio = process.env.AUTOBIO || 'TRUE';
let botname = process.env.BOTNAME || 'WAGWANS AI';

const owner = process.env.DEV || '254717407351'; // This will send a notification once the bot reconnects
const {
